    ...
    : QDialog(parent)
{
	...
	connect(btnCancel,SIGNAL(clicked()),this,SLOT(quit()));
	...
	btnGen->setToolTip(tr("Generate xml files from SMS DB."));
	btnOK->setToolTip(tr("Insert data from xml files to SMS DB"));
}
...
void XMLParser::generationXmlFile()
{
...
QString XMLParser::setDirectory(){
	QString dir = QDir::currentPath();
	QString dirname;
	QString fullname;
	QFileDialog fdialog(this);
 ...
 */
bool XMLParser::saveQnhXmlFile(const Qnh & qnhClass, const QString dirname)
{
...
bool XMLParser::saveOutputXmlFile(const Aoi & aoiClass, const QString dirname)
{
...
bool XMLParser::saveBaXmlFile(const Ba & baClass, const QString dirname)
{
...
bool XMLParser::saveStcaXmlFile(const Stca & stcaClass, const QString dirname)
{
...
bool XMLParser::saveMsawXmlFile(const Msaw & msawClass, const QString dirname)
{
...
/**
 * 파일들을 선택한뒤, 데이터 베이스에 저장하기 위한 함수
 */

void XMLParser::saveXml()
{
	bool chk;
	int i = 0;
...
bool XMLParser::outputXmlProcess(QFile & file)
{
...
bool XMLParser::baXmlProcess(QFile & file)
{
	bool chk;
	QDomDocument doc;
	Ba baClass;
...
bool XMLParser::qnhXmlProcess(QFile & file)
{
	bool chk;
	QDomDocument doc;
	Qnh qnhClass;
...
bool XMLParser::stcaXmlProcess(QFile & file)
{
...
bool XMLParser::msawXmlProcess(QFile & file)
{
...
bool XMLParser::openFile(QFile & file)
{
...
bool XMLParser::checkDomDocument(QFile & file, QDomDocument & doc)
{
 ...
 * 	Check types
 */
bool XMLParser::checkType(QString & type)
{
	if(type == "S"){
...
bool XMLParser::checkDuplicationPK(const QString &name, const int area)
{
...
bool XMLParser::insertMainRecord(const Qnh & qnhClass)
{
...
bool XMLParser::insertMainRecord(const Aoi & aoiClass)
{
	QString sql;
...
bool XMLParser::insertMainRecord(const Ba & baClass)
{
	QString sql;
...
bool XMLParser::insertMainRecord(const Stca & stcaClass)
{
	QString sql;
...
bool XMLParser::insertMainRecord(const Msaw & msawClass)
{
	QString sql;
 ...
 */
bool XMLParser::insertPolygonRecord(const Aoi &aoiClass)
{
	int idx = 1;
	QString sql;
	bool isError = false;
...
bool XMLParser::insertPolygonRecord(const Ba &baClass)
{
	int idx = 1;
	QString sql;
	bool isError = false;
...
bool XMLParser::insertPolygonRecord(const Qnh &qnhClass)
{
	int idx = 1;
	QString sql;
	bool isError = false;
...
bool XMLParser::insertPolygonRecord(const Stca &stcaClass)
{
	int idx = 1;
	QString sql;
	bool isError = false;
...
bool XMLParser::insertPolygonRecord(const Msaw &msawClass)
{
	int idx = 1;
	QString sql;
	bool isError = false;
...
bool XMLParser::insertSectorRecord(const Qnh &qnhClass)
{
	QString sql;
	bool isError = false;
...
bool XMLParser::insertSectorRecord(const Aoi &aoiClass)
{
	QString sql;
	bool isError = false;
...
bool XMLParser::insertSectorRecord(const Ba &baClass)
{
	QString sql;
	bool isError = false;
...
bool  XMLParser::insertSectorRecord(const Stca &stcaClass)
{
	QString sql;
	bool isError = false;
...
bool  XMLParser::insertSectorRecord(const Msaw &msawClass)
{
	QString sql;
	bool isError = false;
...
bool XMLParser::deleteCreatedRecords()
{
...
bool XMLParser::readOutputTable()
{
...
bool XMLParser::retrieverecords(QVector<QStringList> & records, QString & sql)
{
